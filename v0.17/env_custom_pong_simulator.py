...
class CustomPongSimulator:
    ...
    def __init__(self, width=None, height=None, max_score=None, max_steps=None, cpu_difficulty=None):
        ...
        cpu_speed = EnvConfig.COMPUTER_SPEEDS.get(cpu_difficulty or EnvConfig.COMPUTER_DIFFICULTY,
                                                    EnvConfig.COMPUTER_SPEEDS['medium'])
        self.cpu_opponent = CPUOpponentController(
            self.width, self.height,
            self.paddle_height,
            cpu_speed,
            EnvConfig.COMPUTER_REACTION_ENABLED
        )
        ...
        self.cpu_reaction_enabled = EnvConfig.COMPUTER_REACTION_ENABLED
        self.computer_reaction_enabled = EnvConfig.COMPUTER_REACTION_ENABLED  # Alias for backward compatibility
    ...
    def _check_collisions(self):
        ...
        if self.collision_detector.check_player_paddle_collision(
        ...
        elif self.collision_detector.check_cpu_paddle_collision(
                self.physics.ball_x, self.physics.ball_y,
